...
clone_dir https://github.com/kiddin9/op-packages luci-app-wizard openwrt-bandix luci-app-bandix luci-theme-edge luci-app-control-weburl luci‑app‑homebox
